...
class OldMonk:
    ...
    def evaluationfn(self,PlayerColor,oppColor):
        ...
        #if( self.board[0][0]== PlayerColor or self.board[0][7]== PlayerColor or self.board[7][0]== PlayerColor or self.board[7][7]== PlayerColor):
        #    score =
        if (self.board[0][0]!= ' '):
            ...
            if(self.board[0][1]==PlayerColor and self.board[1][0] == PlayerColor and self.board[1][1]== PlayerColor):
                playerClose = 3
            else:
                if(self.board[0][1]==PlayerColor or self.board[1][0] == PlayerColor or self.board[1][1]== PlayerColor):
                    playerClose = 1.5
            if(self.board[0][1]==oppColor and self.board[1][0] == oppColor and self.board[1][1]== oppColor):
                oppClose = 3
            else:
                if(self.board[0][1]==oppColor or self.board[1][0] == oppColor or self.board[1][1]== oppColor):
                    oppClose = 1.5
        if (self.board[0][7]!= ' '):
            if (self.board[0][07]== PlayerColor):
                playerCorner = playerCorner+1
            else:
                oppCorner = oppCorner+1
        else:
            if(self.board[0][6]==PlayerColor and self.board[1][6] == PlayerColor and self.board[1][7]== PlayerColor):
                playerClose = 3
            else:
                if(self.board[0][6]==PlayerColor or self.board[1][6] == PlayerColor or self.board[1][7]== PlayerColor):
                    playerClose = 1.5
            if(self.board[0][1]==oppColor and self.board[1][6] == oppColor and self.board[1][7]== oppColor):
                oppClose = 3
            else:
                if(self.board[0][6]==oppColor or self.board[1][6] == oppColor or self.board[1][7]== oppColor):
                    oppClose = 1.5
        if (self.board[7][0]!= ' '):
            ...
            if(self.board[6][0]==PlayerColor and self.board[7][1] == PlayerColor and self.board[6][1]== PlayerColor):
                playerClose = 3
            else:
                if(self.board[6][0]==PlayerColor or self.board[7][1] == PlayerColor or self.board[6][1]== PlayerColor):
                    playerClose = 1.5
            if(self.board[6][0]==oppColor and self.board[7][1] == oppColor and self.board[6][1]== oppColor):
                oppClose = 3
            else:
                if(self.board[6][0]==oppColor or self.board[7][1] == oppColor or self.board[6][1]== oppColor):
                    oppClose = 1.5
        if (self.board[7][7]!= ' '):
            ...
            if(self.board[7][6]==PlayerColor and self.board[6][7] == PlayerColor and self.board[6][6]== PlayerColor):
                playerClose = 3
            else:
                if(self.board[7][6]==PlayerColor or self.board[6][7] == PlayerColor or self.board[6][6]== PlayerColor):
                    playerClose = 1.5
            if(self.board[7][6]==oppColor and self.board[6][7] == oppColor and self.board[6][6]== oppColor):
                oppClose = 3
            else:
                if(self.board[7][6]==oppColor or self.board[1][6] == oppColor or self.board[6][6]== oppColor):
                    oppClose = 1.5
